...
public class BinaryInt {
    ...
    public BinaryInt sum(BinaryInt bin) throws BinaryArrayException {
        ...
        /*System.out.println(Arrays.toString(this.binaryNumber));
        System.out.println(Arrays.toString(bin.binaryNumber));
        
        if(this.bitSize>bin.bitSize){
            aux2 = new BinaryInt(bin.original,this.bitSize);
            normalized = aux2.fullBynaryNumber();
            other = this.fullBynaryNumber();
        }
        else{
            aux2 = new BinaryInt(this.original,bin.bitSize);
            normalized = aux2.fullBynaryNumber();
            other = bin.fullBynaryNumber();
        }*/
        
        
        if (this.signed == bin.signed) {
            overflowTest = true;
        }
        ...
        if (resp[0] == !bin.signed && overflowTest == true) {
    ...
    public BinaryInt sub(BinaryInt bin) throws BinaryArrayException {
        ...
        if(this.bitSize>=bin.bitSize){
            bin = new BinaryInt(bin.original,this.bitSize);
        }
        else{
            aux = new BinaryInt(this.original,bin.bitSize);
        }
        
        //System.out.println("bin: "+Arrays.toString(bin.fullBynaryNumber()));
        //System.out.println("this: "+Arrays.toString(aux.fullBynaryNumber()));
